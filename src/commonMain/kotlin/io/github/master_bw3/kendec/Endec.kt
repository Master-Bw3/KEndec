...
import io.github.master_bw3.kendec.clamped
import io.github.master_bw3.kendec.ranged
import io.github.master_bw3.kendec.impl.*
...
interface Endec<T> {
     ...
     * structure on error, must wrap their initial reads in a call to [io.github.master_bw3.kendec.Deserializer.tryRead]
     ...
     * once for the provided `value` and return the serializer's [result][io.github.master_bw3.kendec.Serializer.result]
     */
    ...
    fun listOf(): Endec<List<T>> {
        return endecOf(
            { ctx: SerializationContext, serializer: Serializer<*>, list: List<T> ->
    ...
    fun mapOf(): Endec<Map<String, T>> {
        return endecOf(
            { ctx: SerializationContext, serializer: Serializer<*>, map: Map<String, T> ->
     ...
     * the current [serialization context][io.github.master_bw3.kendec.SerializationContext]
     */
    ...
    fun catchErrors(decodeOnError: DecoderWithError<T>): Endec<T> {
        return endecOf<T>(
            { ctx: SerializationContext, serializer: Serializer<*>, value: T ->
                this.encode(
                    ctx,
                    serializer,
                    value
     ...
     * with key `key` into/from a [io.github.master_bw3.kendec.util.MapCarrier],
...
fun <T> unitEndecOf(instance: T): StructEndec<T> {
    return _root_ide_package_.io.github.master_bw3.kendec.unitEndecOf { instance }
}
...
fun <K, V> mapEndecOf(
    ...
    return endecOf(
        { ctx: SerializationContext, serializer: Serializer<*>, map: Map<K, V> ->
...
class PrimitiveEndecs {
    companion object {
        ...
        val BOOLEAN: Endec<Boolean> =
            endecOf(
                { ctx: SerializationContext, serializer: Serializer<*>, value: Boolean ->
                ...
                { ctx: SerializationContext, deserializer: Deserializer<*> ->
                    deserializer.readBoolean(ctx)
                })

        @JsStatic
        val BYTE: Endec<Byte> = endecOf(
            { ctx: SerializationContext, serializer: Serializer<*>, value: Byte ->
            ...
            { ctx: SerializationContext, deserializer: Deserializer<*> ->
                deserializer.readByte(ctx)
            })

        @JsStatic
        val SHORT: Endec<Short> = endecOf(
            { ctx: SerializationContext, serializer: Serializer<*>, value: Short ->
            ...
            { ctx: SerializationContext, deserializer: Deserializer<*> ->
                deserializer.readShort(ctx)
            })

        @JsStatic
        val INT: Endec<Int> = endecOf(
            { ctx: SerializationContext, serializer: Serializer<*>, value: Int ->
                serializer.writeInt(
                    ctx,
                    value
                )
            ...
            { ctx: SerializationContext, deserializer: Deserializer<*> ->
                deserializer.readInt(ctx)
            })

        @JsStatic
        val VAR_INT: Endec<Int> = endecOf(
            { ctx: SerializationContext, serializer: Serializer<*>, value: Int ->
            ...
            { ctx: SerializationContext, deserializer: Deserializer<*> ->
                deserializer.readVarInt(ctx)
            })

        @JsStatic
        val LONG: Endec<Long> = endecOf(
            { ctx: SerializationContext, serializer: Serializer<*>, value: Long ->
            ...
            { ctx: SerializationContext, deserializer: Deserializer<*> ->
                deserializer.readLong(ctx)
            })

        @JsStatic
        val VAR_LONG: Endec<Long> = endecOf(
            { ctx: SerializationContext, serializer: Serializer<*>, value: Long ->
            ...
            { ctx: SerializationContext, deserializer: Deserializer<*> ->
                deserializer.readVarLong(ctx)
            })

        @JsStatic
        val FLOAT: Endec<Float> = endecOf(
            { ctx: SerializationContext, serializer: Serializer<*>, value: Float ->
            ...
            { ctx: SerializationContext, deserializer: Deserializer<*> ->
                deserializer.readFloat(ctx)
            })

        @JsStatic
        val DOUBLE: Endec<Double> =
            endecOf(
                { ctx: SerializationContext, serializer: Serializer<*>, value: Double ->
                ...
                { ctx: SerializationContext, deserializer: Deserializer<*> ->
                    deserializer.readDouble(ctx)
                })

        @JsStatic
        val STRING: Endec<String> =
            endecOf(
                { ctx: SerializationContext, serializer: Serializer<*>, value: String ->
        ...
        val BYTES: Endec<ByteArray> =
            endecOf(
                { ctx: SerializationContext, serializer: Serializer<*>, value: ByteArray ->
