...
open class EdmElement<T : Any> internal constructor(private val value: T, private val type: Type) {
    ...
    /**
     * Create a copy of this EDM element as an [io.github.master_bw3.kendec.format.edm.EdmMap], which
     * implements the [io.github.master_bw3.kendec.util.MapCarrier] interface
     */
    fun asMap(): EdmMap {
