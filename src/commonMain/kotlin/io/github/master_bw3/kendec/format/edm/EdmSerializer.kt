...
import io.github.master_bw3.kendec.util.ifPresent
import kotlin.js.JsExport
import kotlin.js.JsStatic

class EdmSerializer : RecursiveSerializer<EdmElement<*>?>(null),
    SelfDescribedSerializer<EdmElement<*>?> {
    // ---
    ...
    override fun struct(): io.github.master_bw3.kendec.StructSerializer {
    ...
    private inner class MapSerializer<V> (
        ...
        private val ctx: SerializationContext
    ) : io.github.master_bw3.kendec.MapSerializer<V> {
    ...
    private inner class StructSerializer : io.github.master_bw3.kendec.StructSerializer {
        private val result: MutableMap<String, EdmElement<*>> = HashMap()
        ...
        override fun <F> field(
            ...
            value: F,
            mayOmit: Boolean
        ): io.github.master_bw3.kendec.StructSerializer {
            this@EdmSerializer.frame{ encoded ->
