...
open class EdmDeserializer(serialized: EdmElement<*>) : RecursiveDeserializer<EdmElement<*>>(serialized),
        ...
        when (value!!.type()) {
            ...
            EdmElement.Type.MAP -> {
                visitor.map<EdmElement<*>?>(
                    ...
                    value.cast<Map<String, EdmElement<*>>>()
    ...
    private inner class StructDeserializer(private val map: Map<String, EdmElement<*>>) :
