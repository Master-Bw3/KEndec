 ...
 *
 *
 * Check [io.github.master_bw3.kendec.format.edm.EdmDeserializer] for a reference implementation
 */
abstract class RecursiveDeserializer<T> protected constructor(protected val serialized: T) :
    Deserializer<T> {
