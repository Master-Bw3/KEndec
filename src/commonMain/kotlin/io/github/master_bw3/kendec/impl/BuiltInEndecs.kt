...
import io.github.master_bw3.kendec.SerializationAttributes
import io.github.master_bw3.kendec.ifAttr
...
class BuiltInEndecs {
    companion object {
        ...
        val Uuid: Endec<Uuid> = ifAttr(
            ...
            PrimitiveEndecs.STRING.xmap(
                { name: String -> uuidFrom(name) },
                { it.toString() })
        ).orElse(
